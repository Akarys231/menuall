    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-center items-center backdrop-blur-lg bg-black/30">
            ...
            >
                ...
                <div className="bg-[#F5F4F2] mt-6 rounded-lg">

                <h2 className="text-lg font-bold flex ms-2 items-center gap-2 pt-2 mx-4 ms-4">
                ...
                <div className="bg-white p-4 rounded-lg mt-1 flex-1 overflow-y-auto max-h-[50vh] mx-4 mb-4">
                    <div className="space-y-2">
                        {cartItems.map((item, i) => (
                            <div key={i} className="flex justify-between text-sm font-medium text-left border-b border-[#F5F4F2] pb-1">
                                <span className="w-40 truncate">{item.name} {item.quantity > 1 ? `x${item.quantity}` : ''}</span>
